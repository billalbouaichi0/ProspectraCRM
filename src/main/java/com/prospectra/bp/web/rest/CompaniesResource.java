...
/**
 * REST controller for managing {@link com.prospectra.bp.domain.Companies}.
 */
@RestController
...
public class CompaniesResource {
    ...
    private static final String ENTITY_NAME = "prospectraCompanies";
    ...
    public CompaniesResource(CompaniesService companiesService, CompaniesRepository companiesRepository) {
    ...
    public ResponseEntity<CompaniesDTO> updateCompanies(
        ...
        CompaniesDTO result = companiesService.update(companiesDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, companiesDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CompaniesDTO> partialUpdateCompanies(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, companiesDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CompaniesDTO>> getAllCompanies(
        ...
        Page<CompaniesDTO> page;
        if (eagerload) {
            page = companiesService.findAllWithEagerRelationships(pageable);
        } else {
            page = companiesService.findAll(pageable);
        }
